...
@shared_task(bind=True, name="app.core.celery.tasks.retry_task", 
            max_retries=3, default_retry_delay=1)
...
@shared_task(bind=True, name="app.core.celery.tasks.long_running_task",
            time_limit=1, soft_time_limit=0.5)
